import { mcsTranslatorTextSecretKey } from '../../config';
...
function getToken(): Promise<string> {
  ...
  if (now - tokenTimestamp > 1000 * 60 * 9) {
    // 前回のToken取得から9分以上経過していたら再度取得。
        ...
        request(
          {
            ...
            url:
              ...
              `?text=${encodeURI(text)}&from=${translateFrom}&to=${translateTo}`,
            headers: {
